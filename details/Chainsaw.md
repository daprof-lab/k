# ⚙️ **Chainsaw Event Scanner**
### `File Name: Chainsaw.mkape`
...
High-speed Rust-based EVTX engine to search log folders using Sigma rules and custom queries.

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Chainsaw Event Scanner to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Chainsaw Event Scanner logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Chainsaw Event Scanner timeline outputs to isolate exactly when unauthorized scripts were loaded.
