...
Replicates the SANS DFIR standard collection, pulling comprehensive evidence for rapid triage.

---

## 🔍 **Investigative Use-Cases**
* **Forensic Investigation**: Extract raw records from SANS Triage Suite to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate SANS Triage Suite events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit SANS Triage Suite storage states to identify potential exfiltration triggers or local file deletions.
