# ⚙️ **Volatility Dumpfiles**
### `File Name: Volatility_dumpfiles.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Dumpfiles to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Dumpfiles logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Dumpfiles timeline outputs to isolate exactly when unauthorized scripts were loaded.
