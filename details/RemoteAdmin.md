...
* **Forensic Investigation**: Extract raw records from Remote Admin to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Remote Admin events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Remote Admin storage states to identify potential exfiltration triggers or local file deletions.
...
Targets:
    ...
    -
        Name: NetMonitor
        Category: ApplicationLogs
        Path: NetMonitorforEmployeesProfessional.tkape
    -
        Name: QuickAssist
        Category: ApplicationLogs
        Path: QuickAssist.tkape
    -
        Name: Radmin
        Category: ApplicationLogs
        Path: Radmin.tkape
    ...
    -
        ...
        Category: ApplicationLogs
        Path: RemoteManipulatorSystem.tkape
        Comment: "Contains logs related to Remote Manipulator System"
    -
        Name: Remote Utilities
        Category: ApplicationLogs
        Path: RemoteUtilities_app.tkape
        Comment: "Contains logs related to the App RemoteUtilities"
    -
        Name: RustDesk
        Category: ApplicationLogs
        Path: RustDesk.tkape
        Comment: "Contains logs related to RustDesk"
    -
    ...
    -
        Name: Splashtop
        Category: ApplicationLogs
        Path: Splashtop.tkape
    -
        Name: Supremo Remote Desktop Control
        Category: ApplicationLogs
        Path: SupremoRemoteDesktop.tkape
    -
        Name: TeamViewer
        Category: ApplicationLogs
