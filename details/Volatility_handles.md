# ⚙️ **Volatility Handles**
### `File Name: Volatility_handles.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Handles to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Handles logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Handles timeline outputs to isolate exactly when unauthorized scripts were loaded.
