# 🎯 **Roaming Profile**
### `File Name: RoamingProfile.tkape`
...
* **Forensic Investigation**: Extract raw records from Roaming Profile to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Roaming Profile events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Roaming Profile storage states to identify potential exfiltration triggers or local file deletions.
