# 🎯 **Macrium Reflect**
### `File Name: MacriumReflect.tkape`
...
* **Forensic Investigation**: Extract raw records from Macrium Reflect to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Macrium Reflect events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Macrium Reflect storage states to identify potential exfiltration triggers or local file deletions.
