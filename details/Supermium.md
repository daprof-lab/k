...
* **Forensic Investigation**: Extract raw records from Supermium to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Supermium events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Supermium storage states to identify potential exfiltration triggers or local file deletions.
...
Author: Reece394, Yogesh Khatri
Version: 1.1
Id: 0f708588-d35a-42ed-a22a-d0fd163dccae
RecreateDirectories: true
Targets:
    -
        Name: Supermium Bookmarks XP
        Category: Communications
        Path: C:\Documents and Settings\%user%\Application Data\Supermium\User Data\*\
        FileMask: Bookmarks*
    -
    ...
    -
        ...
        Category: Communications
        Path: C:\Documents and Settings\%user%\Application Data\Supermium\User Data\*\Sessions\
        Recursive: false
    -
    ...
    -
        ...
        Category: Communications
        Path: C:\Documents and Settings\%user%\Application Data\Supermium\User Data\*\Sync Data
        Recursive: true
    -
    ...
    -
        ...
        Category: Communications
        Path: C:\Users\%user%\AppData\Local\Supermium\User Data\*\
        FileMask: Bookmarks*
    -
    ...
    -
        ...
        Category: Communications
        Path: C:\Users\%user%\AppData\Local\Supermium\User Data\*\Sessions\
        Recursive: false
    -
    ...
    -
        ...
        FileMask: Preferences
    -
        Name: Supermium Secure Preferences
        Category: Communications
        Path: C:\Users\%user%\AppData\Local\Supermium\User Data\*\
    ...
    -
        ...
        Category: Communications
        Path: C:\Users\%user%\AppData\Local\Supermium\User Data\*\Sync Data
        Recursive: true
    -
    ...
    -
        ...
        Category: Communications
        Path: C:\Users\%user%\AppData\Local\Supermium\User Data\Snapshots\*\
        Recursive: true
        Comment: "Grabs folder that appears to have snapshots of Supermium SQLite DBs organized by version #."
    -
        Name: SYSTEM Supermium History
        Category: Communications
        Path: C:\Windows\system32\config\systemprofile\AppData\Local\Supermium\User Data\*\
        FileMask: History*
