# ⚙️ **Volatility Psscan**
### `File Name: Volatility_psscan.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Psscan to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Psscan logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Psscan timeline outputs to isolate exactly when unauthorized scripts were loaded.
