# ⚙️ **Volatility Mftparser**
### `File Name: Volatility_mftparser.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Mftparser to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Mftparser logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Mftparser timeline outputs to isolate exactly when unauthorized scripts were loaded.
