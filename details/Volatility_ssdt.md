# ⚙️ **Volatility Ssdt**
### `File Name: Volatility_ssdt.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Ssdt to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Ssdt logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Ssdt timeline outputs to isolate exactly when unauthorized scripts were loaded.
