...
* **Bulk Automated Parsing**: Run Sum Ecmd to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Sum Ecmd logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Sum Ecmd timeline outputs to isolate exactly when unauthorized scripts were loaded.
...
BinaryUrl: https://download.ericzimmermanstools.com/SumECmd.zip
ExportFormat: csv
Processors:
    -
