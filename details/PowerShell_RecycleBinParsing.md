# ⚙️ **PowerShell Recycle Bin Parser**
### `File Name: PowerShell_RecycleBinParsing.mkape`
...
Parses Windows Recycle Bin directory states using lightweight PowerShell scripts, outputting mapped paths and file sizes to structured files.

---

## 🔍 **Investigative Use-Cases**
* **Lightweight Deletion Recovery**: Extract deleted file records on remote targets without staging external compiled analytical utilities.
* **File Deletion Timeline Sync**: Establish simple timelines of file deletion habits directly on staging hosts.
* **Deleted Files Size Audits**: Review original volumes and types of deleted files during exfiltration cleanup investigations.
