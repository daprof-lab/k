...
* **Forensic Investigation**: Extract raw records from Mattermost to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Mattermost events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Mattermost storage states to identify potential exfiltration triggers or local file deletions.
...
Targets:
    -
        ...
        Category: Apps
        Path: C:\Users\%user%\AppData\Roaming\Mattermost\IndexedDB\
        Recursive: true
        Comment: "Locates Mattermost logs and copies them"
