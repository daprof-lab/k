...
* **Forensic Investigation**: Extract raw records from Thunderbird to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Thunderbird events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Thunderbird storage states to identify potential exfiltration triggers or local file deletions.
