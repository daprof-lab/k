# ⚙️ **Power Shell AD Timeline**
### `File Name: PowerShell_AD_Timeline.mkape`
...
ADTimeline.ps1 - The ADTimeline script generates a timeline based on Active Directory replication metadata for objects considered of interest.

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Power Shell AD Timeline to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Power Shell AD Timeline logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Power Shell AD Timeline timeline outputs to isolate exactly when unauthorized scripts were loaded.
