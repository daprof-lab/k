# ⚙️ **Volatility Memdump**
### `File Name: Volatility_memdump.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Memdump to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Memdump logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Memdump timeline outputs to isolate exactly when unauthorized scripts were loaded.
