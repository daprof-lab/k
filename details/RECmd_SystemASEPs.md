# ⚙️ **Recmd System Aseps**
### `File Name: RECmd_SystemASEPs.mkape`
...
* **Bulk Automated Parsing**: Run Recmd System Aseps to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Recmd System Aseps logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Recmd System Aseps timeline outputs to isolate exactly when unauthorized scripts were loaded.
