# ⚙️ **Zircolite Sigma Scanner**
### `File Name: Zircolite_Scan.mkape`
...
Applies standard Sigma rules directly against EVTX directories using SQLite query engines.

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Zircolite Sigma Scanner to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Zircolite Sigma Scanner logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Zircolite Sigma Scanner timeline outputs to isolate exactly when unauthorized scripts were loaded.
