# ⚙️ **Volatility Notepad**
### `File Name: Volatility_notepad.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Notepad to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Notepad logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Notepad timeline outputs to isolate exactly when unauthorized scripts were loaded.
