# ⚙️ **Volatility Filescan**
### `File Name: Volatility_filescan.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Filescan to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Filescan logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Filescan timeline outputs to isolate exactly when unauthorized scripts were loaded.
