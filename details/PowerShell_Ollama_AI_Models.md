# ⚙️ **Power Shell Ollama AI Models**
### `File Name: PowerShell_Ollama_AI_Models.mkape`
...
Ollama-AI Installed LLM's

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Power Shell Ollama AI Models to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Power Shell Ollama AI Models logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Power Shell Ollama AI Models timeline outputs to isolate exactly when unauthorized scripts were loaded.
