# ⚙️ **Power Shell Processes**
### `File Name: PowerShell_Processes.mkape`
...
Display a running process list with a variety of fields - modified

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Power Shell Processes to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Power Shell Processes logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Power Shell Processes timeline outputs to isolate exactly when unauthorized scripts were loaded.
