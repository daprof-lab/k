# ⚙️ **Recmd Registry Aseps**
### `File Name: RECmd_RegistryASEPs.mkape`
...
* **Bulk Automated Parsing**: Run Recmd Registry Aseps to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Recmd Registry Aseps logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Recmd Registry Aseps timeline outputs to isolate exactly when unauthorized scripts were loaded.
