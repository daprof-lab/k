# ⚙️ **Volatility Consoles**
### `File Name: Volatility_consoles.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Consoles to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Consoles logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Consoles timeline outputs to isolate exactly when unauthorized scripts were loaded.
