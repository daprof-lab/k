# ⚙️ **Thor Lite Scan**
### `File Name: Thor-Lite_Scan.mkape`
...
* **Bulk Automated Parsing**: Run Thor Lite Scan to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Thor Lite Scan logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Thor Lite Scan timeline outputs to isolate exactly when unauthorized scripts were loaded.
