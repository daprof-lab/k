# ⚙️ **Power Shell Tcpconnections**
### `File Name: PowerShell_TCPConnections.mkape`
...
TCP Established Connections including DNSCache and process information

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Power Shell Tcpconnections to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Power Shell Tcpconnections logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Power Shell Tcpconnections timeline outputs to isolate exactly when unauthorized scripts were loaded.
