...
* **Forensic Investigation**: Extract raw records from Open SUSE to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Open SUSE events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Open SUSE storage states to identify potential exfiltration triggers or local file deletions.
...
Targets:
    -
        ...
        Path: C:\Users\%user%\AppData\Local\Packages\46932SUSE.openSUSE*Leap*\LocalState\rootfs\etc\
        FileMask: "os-release"
    -
    ...
    -
        ...
        Category: Windows Subsystem for Linux
        Path: C:\Users\%user%\AppData\Local\Packages\46932SUSE.openSUSE*Leap*\LocalState\rootfs\
        Recursive: true
    ...
    -
        ...
        Category: Windows Subsystem for Linux
        Path: C:\Users\%user%\AppData\Local\Packages\46932SUSE.openSUSE*Leap*\LocalState\
        FileMask: "ext4.vhdx"
