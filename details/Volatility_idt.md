# ⚙️ **Volatility Idt**
### `File Name: Volatility_idt.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Idt to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Idt logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Idt timeline outputs to isolate exactly when unauthorized scripts were loaded.
