# ⚙️ **Power Shell Network Ipconfiguration**
### `File Name: PowerShell_NetworkIPConfiguration.mkape`
...
Collecting Network IP Configuration and Parsing Specific Fields

---

## 🔍 **Investigative Use-Cases**
* **Bulk Automated Parsing**: Run Power Shell Network Ipconfiguration to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Power Shell Network Ipconfiguration logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Power Shell Network Ipconfiguration timeline outputs to isolate exactly when unauthorized scripts were loaded.
