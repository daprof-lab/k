...
### `File Name: PrismaAccessBrowser.tkape`
...
* **Forensic Investigation**: Extract raw records from Prisma Access Browser to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Prisma Access Browser events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Prisma Access Browser storage states to identify potential exfiltration triggers or local file deletions.
...
Author: Cassie Doemel and Andrew Rathbun, Yogesh Khatri
Version: 1.1
Id: 9a92253a-8406-4f09-86b3-1af4eb4d8f03
...
Targets:
    ...
    -
        ...
        FileMask: Preferences
    -
        Name: Prisma Access Browser Secure Preferences
        Category: Communications
        Path: C:\Users\%user%\AppData\Local\Palo Alto Networks\PrismaAccessBrowser\User Data\*\
