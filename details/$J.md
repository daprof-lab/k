...
The Update Sequence Number (USN) Change Journal. It records metadata changes to files and folders on an NTFS volume, providing a rolling history of disk operations.

---

## 🔍 **Investigative Use-Cases**
* **Historical File Operations Tracking**: Identify files that were created, renamed, modified, or deleted even if their MFT record has since been overwritten.
* **Anti-Forensics Identification**: Detect bulk file deletion activities or timestomping attempts that alter primary file system timestamps.
* **Malware Staging Discovery**: Locate when and where malicious files were temporarily stored and renamed during an active compromise.
