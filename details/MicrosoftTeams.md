# 🎯 **Microsoft Teams**
### `File Name: MicrosoftTeams.tkape`
...
Local Teams SQLite databases, chat histories, active sessions, and local log directories.

---

## 🔍 **Investigative Use-Cases**
* **Forensic Investigation**: Extract raw records from Microsoft Teams to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Microsoft Teams events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Microsoft Teams storage states to identify potential exfiltration triggers or local file deletions.
