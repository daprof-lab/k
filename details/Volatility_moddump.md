# ⚙️ **Volatility Moddump**
### `File Name: Volatility_moddump.mkape`
...
* **Bulk Automated Parsing**: Run Volatility Moddump to parse multiple folders containing acquired target evidence in a single instruction.
* **Structured Report Output**: Generate sorted, structured CSV/JSON databases from raw Volatility Moddump logs to index file anomalies.
* **Incident Impact Assessment**: Leverage Volatility Moddump timeline outputs to isolate exactly when unauthorized scripts were loaded.
