# 🎯 **Microsoft One Note**
### `File Name: MicrosoftOneNote.tkape`
...
* **Forensic Investigation**: Extract raw records from Microsoft One Note to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Microsoft One Note events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Microsoft One Note storage states to identify potential exfiltration triggers or local file deletions.
