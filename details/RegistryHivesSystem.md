...
### `File Name: RegistryHivesSystem.tkape`
...
System-wide registry database files (SYSTEM, SOFTWARE, SAM, SECURITY). These house core system configuration, hardware parameters, installed applications, and local accounts.

---

## 🔍 **Investigative Use-Cases**
* **System Audit & Network Setup**: Determine system hostname, network configuration, active services, and historically connected networks.
* **Autostart Persistence Analysis**: Inspect Run/RunOnce keys, active services, and task scheduler configs to spot threat persistence mechanisms.
* **SAM Credentials Profiling**: Access SAM user listings, account status, security groups, and password hashes for credential audits.
