# 🎯 **Double Commander**
### `File Name: DoubleCommander.tkape`
...
* **Forensic Investigation**: Extract raw records from Double Commander to uncover evidence of user interactions and operational timelines.
* **Compromise Timeline Auditing**: Correlate Double Commander events chronologically with external network indicators of compromise.
* **Data Loss & Exfiltration Review**: Audit Double Commander storage states to identify potential exfiltration triggers or local file deletions.
